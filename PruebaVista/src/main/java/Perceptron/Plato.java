...
public class Plato {
    private static final Map<String, List<String>> REQUISITOS = new HashMap<>();
    private static final Map<String, String> RECETAS = new HashMap<>();
    private static final Map<String, Integer> PRECIOS_BASE = new HashMap<>();
